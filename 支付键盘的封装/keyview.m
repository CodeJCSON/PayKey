...
//        [UIXX.imageView  setContentMode:UIViewContentModeScaleAspectFill];
       ...
       gao=mima.frame.size.height-2;
        ...
        for (int j=0; j<9; j++) {
            ...
            [anbtn   addTarget:self action:@selector(anbtnClicked:) forControlEvents:UIControlEventTouchDown];
            [anbtn   addTarget:self action:@selector(songkai) forControlEvents:UIControlEventTouchUpInside|UIControlEventTouchUpOutside];
        ...
        for (int   q=0; q<3; q++) {
            ...
            [leianbtn   addTarget:self action:@selector(anbtnClicked:) forControlEvents:UIControlEventTouchDown];
            [leianbtn   addTarget:self action:@selector(songkai) forControlEvents:UIControlEventTouchUpInside|UIControlEventTouchUpOutside];
